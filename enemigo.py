...
class Enemigo():
    def __init__(self):
        ...
        self.velocidad = 2 #Velociad de movimiento del bicho
    ...
    def movimiento (self):
        ...
        if (self.contador < 15
            or (vGlobales.DISPLAYSURF.get_at((self.rect.centerx +self.radar[0] *15 +self.vector[0], self.rect.centery +self.vector[1] + self.radar[1] *15))== vGlobales.suelo)):
            self.avanzar()
